...
using BleakwindBuffet.Data.Drinks; //added
...
namespace BleakwindBuffet.DataTests.UnitTests.DrinkTests
{
    public class AretinoAppleJuiceTests
    {
        ...
        public void ShouldHaveCorrectSpecialInstructions(bool includeIce)
        {
            ...
            aj.Ice = includeIce;
            if (includeIce) 
                Assert.Contains("Add ice", aj.SpecialInstructions); //Probably better to break into two small facts rather than using if/else logic
            else 
        ...
        {
            AretinoAppleJuice aj = new AretinoAppleJuice();
            aj.Size = size; //can assume this works correctly
