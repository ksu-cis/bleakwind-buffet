...
namespace BleakwindBuffet.DataTests.UnitTests.EntreeTests
{
    public class ThalmorTripleTests
    {
                                                                    ...
                                                                    bool includeBacon, bool includeEgg)
        {
            ...
            if (includeBacon && includeBun && includeCheese && includeEgg && includeKetchup && includeLettuce && includeMayo && includeMustard && includePickle && includeTomato)
                Assert.Empty(tt.SpecialInstructions);
            else
                Assert.Contains("Hold bacon" + "Hold bun" + "Hold ketchup" + "Hold mustard" + "Hold pickle" + "Hold cheese" + "Hold tomato" +
                    "Hold lettuce" + "Hold mayo" + "Hold egg", tt.SpecialInstructions);
        }
